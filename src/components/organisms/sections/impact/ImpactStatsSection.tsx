...
export const ImpactStatsSection = () => {
  ...
  return (
    <section
      id="impact"
      ref={ref}
      className="py-32 bg-gradient-to-r from-[#138A7E] to-[#0F7961] text-white relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-20 text-center">
          ...
          >
            Resultados tangibles que demuestran nuestro compromiso con la paz
            sostenible
          </p>
        </div>
